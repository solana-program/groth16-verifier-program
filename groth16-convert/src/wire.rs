...
fn decode_body(
    ...
    let vk = groth16_verify::VerifyingKey::from_body(body)
...
mod tests {
    ...
    fn key_body_negates_g2_and_decodes_back() {
        ...
        let vk = groth16_verify::VerifyingKey::from_body(key.body()).unwrap();
    ...
    fn non_canonical_field_is_rejected() {
        ...
        assert_eq!(
            fr_from_bytes(&groth16_verify::constants::FR_MODULUS),
